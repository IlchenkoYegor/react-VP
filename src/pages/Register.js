          ...
          <Col xs="8">
            <Form onSubmit={onSubmit}>
              ...
              <FormGroup className="mb-3">
                ...
                <Form.Control
                  type="text"
                  className={classNames({ "is-invalid": errors.secondName })}
              ...
              <FormGroup className="mb-3">
                ...
                <Form.Text
                  style={!passwordValid ? { color: "red" } : { color: "black" }}
                >
                  enter your password, consider the fact that it should consist
                  of at least 8 letters, 1 character, 1 digit{" "}
                </Form.Text>
              </FormGroup>
